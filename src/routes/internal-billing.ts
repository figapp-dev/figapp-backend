  ...
  app.post(
    "/internal/billing/collect",
    {
      schema: {
        ...
        description:
          "Applies due scheduled seat reductions, creates missing GoCardless one-off payments " +
          "for commercial agencies, sends past_due reminder emails, and suspends on day 29. " +
